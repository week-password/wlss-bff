...
@pytest.fixture
def reject_friendship_request_request():
    return Predicate(method="PUT", path="/friendships/requests/1/rejected", headers={"Authorization": "Bearer token"})


@pytest.fixture
def reject_friendship_request_response():
    response_body = {
        "id": 1,
        "created_at": "2024-02-28T17:25:38.795Z",
        "receiver_id": 1,
